...
void SelectDevice(char *deviceId) {
  ...
  for (int i = 0; i < (int)count; i++) {
    ...
    wcstombs_s(NULL, buffer, varName.pwszVal, 256);
...
static struct PyModuleDef VistaVolEvents_module = {
    PyModuleDef_HEAD_INIT,
    "VistaVolEvents",     /* m_name */
    "Windows Vista+ volume functions",  /* m_doc */
    -1,                  /* m_size */
    VistaVolEvents_methods,    /* m_methods */
    NULL,                /* m_reload */
    NULL,                /* m_traverse */
    NULL,                /* m_clear */
    NULL,                /* m_free */
...
PyObject* PyInit_VistaVolEvents(void) {
    HRESULT hr, skipCOM;
    int iMute;
    float fVolume;
    skipCOM = CoInitializeEx(NULL, COINIT_APARTMENTTHREADED);
    ...
    return PyModule_Create(&VistaVolEvents_module);
Exit:
    if (skipCOM == S_OK) {
        CoUninitialize();
    }
