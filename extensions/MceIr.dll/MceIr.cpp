...
static BOOL MceIrImportProntoRC5(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    if (Length < 20)
        return FALSE;
    if (sscanf_s((PCHAR)pData, "%04x %04x %04x %04x", (unsigned int *) &Proto, (unsigned int *) &Clock, (unsigned int *) &Seq1, (unsigned int *) &Seq2) != 4)
        return FALSE;
    ...
    pData += 20;
    if (sscanf_s((PCHAR)pData, "%04x %04x", (unsigned int *) &System, (unsigned int *) &Command) != 2)
        return FALSE;
    if (System > 31)
        return FALSE;
    if (Command > 127)
...
static BOOL MceIrImportProntoRC5X(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x", (unsigned int *) &System, (unsigned int *) &Command, (unsigned int *) &Data) != 3)
            break;
        if (System > 31) 
            break;
        if (Command > 127) 
...
static BOOL MceIrImportProntoRC6(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        //Read 15 bytes of header
        if (Length < 20) break;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x %04x", (unsigned int *) &Proto, (unsigned int *) &Clock, (unsigned int *) &Seq1, (unsigned int *) &Seq2) != 4) break;
        if (Proto != PRONTO_PROTO_RC6) break;
        if (Seq1 + Seq2 != 1) break;

        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x", (unsigned int *) &System, (unsigned int *) &Command) != 2) break;
        if (System > 255) break;
...
static BOOL MceIrImportProntoRC6A(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x", (unsigned int *) &Customer, (unsigned int *) &System, (unsigned int *) &Command) != 3) break;
        if (System > 255) break;
        if (Command > 255) break;
...
static BOOL MceIrImportProntoLearned(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        if (sscanf_s(pHeader, " %04x %04x %04x", (unsigned int *) &Clock, (unsigned int *) &Seq1, (unsigned int *) &Seq2) != 3) break;
        if (Clock == 0) break;
        ...
        *pReadCount = 0;
        ...
        for(;;)
        {
            ...
            if (!Remaining)
            {
                ...
                if (sscanf_s((PCHAR)pPronto, " %04x", (unsigned int *) &Remaining) != 1)  break;
                Seq--;
