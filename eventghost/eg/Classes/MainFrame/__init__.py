...
GetInternalBitmap = eg.Icons.GetInternalBitmap
CreateBitmapOnTopOfIcon = eg.Icons.CreateBitmapOnTopOfIcon
...
class MainFrame(wx.Frame):
    ...
    def __init__(self, document):
        ...
        wx.EvtHandler().Bind(wx.EVT_MENU, ToggleOnlyLogAssigned, id=toggleOnlyLogAssignedId)
