...
Actions =(
    (#Tuple 0 - most important actions
        ("OpenDialog","Show open dialog","Show open dialog.",'{O}'),
        ("ShowNextPgOrFile","Show next page OR file","Show next page in a multipage image OR load next file in directory.",'{Ctrl+PgDown}'),
        ("ShowPrevPgOrFile","Show previous page OR file","Show previous page in a multipage image OR load previous file in directory.",'{Ctrl+PgUp}'),
        ("ScrollRight","Scroll right","Scroll image right OR next image in directory.",'{Right}'),
        ("ScrollLeft","Scroll left","Scroll image left OR previous image in directory.",'{Left}'),
        ("LoadFirstFile","First file in directory","Load first file in the directory.",'{Ctrl+Home}'),
        ("LoadLastFile","Last file in directory","Load last file in the directory.",'{Ctrl+End}'),
        ("CloseActualWindow","Close actual window","Close actual window (main window, slideshow, full screen,thumbnails or a dialog).",'{Esc}'),
        ("ToggleStatusBar","Show/hide status bar","Show/hide status bar.",'{Alt+Shift+S}'),
        ("ToggleToolbar","Show/hide toolbar","Show/hide toolbar.",'{Alt+Shift+T}'),
        ("ToggleMenuBar","Show/hide menu bar","Show/hide menu bar.",'{Alt+Shift+M}'),
        ("ToggleCaption","Show/hide caption","Show/hide caption.",'{Alt+Shift+C}'),
        ("ToggleFit","Fit to desktop/Fit to image","Switch (toggle) between 'Fit images to desktop' and 'Fit window to image'.",'{F}'),
        ("ZoomIn","Zoom In","Zoom In.",'{Add}'),
        ("ZoomOut","Zoom Out","Zoom Out.",'{Subtract}'),
        ("OriginalSize","Original size","Original size (no zoom).",'{Ctrl+H}'),
        ("FullScreen","Full Screen","Full Screen.",'{Enter}'),
        ("FullScreenMode1","Full screen mode 1:1","Full screen mode: Show images/movies with the original size (1:1).",'{1}'),
        ("FullScreenMode2","Large fit to full screen","Full screen mode: Fit to screen only large images.",'{2}'),
        ("FullScreenMode3","All fit to full screen","Full screen mode: Fit to screen all images/movies.",'{3}'),
        ("FullScreenMode4","All stretch to full screen","Full screen mode: Stretch all images/movies to screen.",'{4}'),
        ("StartDirSlideshow","Start directory slideshow","Start slideshow with current directory files.",'{Ctrl+W}'),
        ("ToggleAutSlideshow1","Start/stop automatic slideshow","Start/stop automatic viewing (slideshow in window).",'{Shift+A}'),
        ("ToggleAutSlideshow2","Pause/Resume automatic slideshow","Pause an automatic slideshow. Press this key again to resume the slideshow.",'{Pause}'),
        ("MinimizeWindow","Minimize IrfanView window","Minimize IrfanView window - Boss key ;-).",'{M}'),
    ),(#Tuple 1 - File menu
        #("OpenDialog","Show Open dialog","Show Open dialog.",'{O}'),
        ("ReopenFile","Reopen file","Reopen file.",'{Shift+R}'),
        ("OpenInExternal","Open in external","Open in external viewer/editor.",'{Shift+E}'),
        ("Thumbnails","Thumbnails","Thumbnails.",'{T}'),
        ("SlideshowDialog","Show Slideshow dialog","Show Slideshow dialog.",'{W}'),
        ("BatchConversionRename","Batch Conversion/Rename","Batch Conversion/Rename.",'{B}'),
        ("RenameFile","Rename file","Rename file.",'{F2}'),
        ("MoveFile","Move file","Move file.",'{F7}'),
        ("CopyFile","Copy file","Copy file.",'{F8}'),
        ("DeleteFile","Delete file","Delete file.",'{Del}'),
        ("SaveDialog","Show Save dialog","Show Save dialog.",'{Ctrl+S}'),
        ("SaveAs",'Show "Save as" dialog','Show "Save as" dialog.','{S}'),
        ("PrintDialog","Show Print dialog","Show Print dialog.",'{Ctrl+P}'),
        ("DirectPrint","Direct print","Print image, hide print(dialog (direct print).",'{Ctrl+Alt+P}'),
        ("AcquireBatchScanning","Acquire/Batch Scanning","Acquire/Batch Scanning.",'{Ctrl+Shift+A}'),
        #("CloseActualWindow","Close actual window","Close actual window (main window, slideshow, full screen, thumbnails or a dialog).",'{Esc}'),
        ("SearchFiles","Search files","Search files.",'{Ctrl+F}'),
    ),(#Tuple 2 - Edit menu
        ("EditUndo","Edit - Undo","Edit - Undo.",'{Ctrl+Z}'),
        ("CreateSelection","Create custom selection","Create custom selection.",'{Shift+C}'),
        ("InsertText","Insert text into selection","Edit - Insert text into selection.",'{Ctrl+T}'),
        ("CutSelectionRectangle","Cut selection rectangle","Cut selection rectangle.",'{Ctrl+X}'),
        ("CropSelectionRectangle","Crop selection rectangle","Crop selection rectangle.",'{Ctrl+Y}'),
        ("CopyToClipboard","Copy image to clipboard","Copy image to clipboard.",'{Ctrl+C}'),
#        ("PasteFromClipboard","Paste image from clipboard","Paste image from clipboard.",'{Ins}'),
        ("PasteFromClipboard","Paste from clipboard","Paste image from clipboard.",'{Ctrl+V}'),
        ("EditDelete","Delete (Clear display) ","Delete - clear display.",'{D}'),
    ),(#Tuple 3 - Picture menu
        ("ShowInformation","Show image information","Show image information.",'{I}'),
        ("RotateLeft","Rotate left","Rotate left.",'{L}'),
        ("RotateRight","Rotate right","Rotate right.",'{R}'),
        ("RotateAngle","User/Fine rotation","Rotate by angle.",'{Ctrl+U}'),
        ("VerticalFlip","Vertical flip","Vertical flip.",'{V}'),
        ("HorizontalFlip","Horizontal flip","Horizontal flip.",'{H}'),
        ("ResampleDialog","Show Resample dialog","Show Resample dialog.",'{Ctrl+R}'),
        ("EnhanceColors","Enhance colors","Enhance colors.",'{Shift+G}'),
        ("AutoColorCorrection","Auto color correction","Auto color correction.",'{Shift+U}'),
        ("Sharpen","Sharpen","Sharpen.",'{Shift+S}'),
        ("RedEyeReduction","Red eye reduction","Red eye reduction.",'{Shift+Y}'),
        ("EffectsSetup","Effects setup","Effects setup.",'{Ctrl+E}'),
        ("AdobeFiltersDialog","Adobe 8BF filters dialog","Adobe 8BF filters dialog.",'{Ctrl+K}'),
        ("FilterFactoryDialog","Filter Factory dialog","Filter Factory dialog.",'{K}'),
        ("RotationLeft","Lossless JPG rotation Left","Lossless JPG rotation - to left.",'{Ctrl+Shift+L}'),
        ("RotationRight","Lossless JPG rotation right","Lossless JPG rotation - to right.",'{Ctrl+Shift+R}'),
    ),(#Tuple 4 - Settings menu
        ("PropertiesDialog","Show Properties dialog","Show Properties dialog.",'{P}'),
        ("StopAnimation","Stop animation","Stop GIF or ANI animation.",'{G}'),
        ("ShowCommentDialog","Show Comment dialog JPGs","Show Comment dialog for JPGs.",'{Ctrl+Shift+M}'),
        ("JpgLosslessOperations","JPG lossless operations","JPG lossless operations.",'{Shift+J}'),
        ("CaptureDialog","Show Capture dialog","Show Capture dialog.",'{C}'),
        #("MinimizeWindow","Minimize IrfanView window","Minimize IrfanView window - Boss key ;-).",'{M}'),
        ("WallpaperCentered","Wallpaper centered","Set as wallpaper - centered.",'{Ctrl+Shift+C}'),
        ("WallpaperTiled","Wallpaper tiled","Set as wallpaper - tiled.",'{Ctrl+Shift+T}'),
        ("WallpaperStretched","Wallpaper stretched","Set as wallpaper - stretched.",'{Ctrl+Shift+S}'),
        ("PreviousWallpaper","Previous wallpaper","Set as wallpaper - previous wallpaper.",'{Ctrl+Shift+P}'),
    ),(#Tuple 5 - View menu
        #("ToggleStatusBar","Show/hide status bar","Show/hide status bar.",'{Alt+Shift+S}'),
        #("ToggleToolbar","Show/hide toolbar","Show/hide toolbar.",'{Alt+Shift+T}'),
        #("ToggleMenuBar","Show/hide menu bar","Show/hide menu bar.",'{Alt+Shift+M}'),
        ...
        #("FullScreen","Full Screen","Full Screen.",'{Enter}'),
        #("FullScreenMode1","Full screen mode 1:1","Full screen mode: Show images/movies with the original size (1:1).",'{1}'),
        #("FullScreenMode2","Large fit to full screen","Full screen mode: Fit to screen: large images only.",'{2}'),
        #("FullScreenMode3","All fit to full screen","Full screen mode: Fit to screen: all images/movies.",'{3}'),
        #("FullScreenMode4","All stretch to full screen","Full screen mode: Stretch all images/movies to screen.",'{4}'),
        ("LoadNextFile","Next file in directory","Load next file in directory.",'{Space}'),
        ("LoadPrevFile","Previous file in directory","Load previous file in directory.",'{Backspace}'),
        #("LoadFirstFile","Load first file","Load first file in the directory.",'{Ctrl+Home}'),
        #("LoadLastFile","Load last file","Load last file in the directory.",'{Ctrl+End}'),
        ("OpenRandomImage","Open random image","Open random image from the directory.",'{Ctrl+M}'),
        ("Refresh","Refresh","Refresh (display and directory list).",'{F5}'),
        #("ToggleAutSlideshow1","Start/stop automatic slideshow","Start/stop automatic viewing (slideshow in window).",'{Shift+A}'),
        #("ZoomIn","Zoom In","Zoom In.",'{Add}'),
        #("ZoomOut","Zoom Out","Zoom Out.",'{Subtract}'),
        ("ToggleLockZoom","Lock/unlock zoom","Lock/unlock zoom (also in full screen mode).",'{Shift+L}'),
        #("OriginalSize","Original size","Original size (no zoom).",'{Ctrl+H}'),
        ("ShowInHexViewer","Show in HEX viewer","Show image in HEX viewer.",'{F3}'),
        ("EditMultipageTif","Edit multipage TIF","Edit multipage TIF.",'{Ctrl+Q}'),
        #("ShowNextPgOrFile","Show next page OR file","Show next page in a multipage image OR load next file in directory.",'{Ctrl+PgDown}'),
        #("ShowPrevPgOrFile","Show previous page OR file","Show previous page in a multipage image OR load previous file in directory.",'{Ctrl+PgUp}'),
        ("ScrollImageUp","Scroll image up","Scroll image up.",'{Up}'),
        ("ScrollImageDown","Scroll image down","Scroll image down.",'{Down}'),
        ("ScrollRightOrNext","Scroll right OR next image","Scroll image right OR next image in directory.",'{Right}'),
        ("ScrollLeftOrPrevious","Scroll left OR previous","Scroll image left OR previous image in directory.",'{Left}'),
        ("ScrollUpOrPrevious","Scroll up OR previous file","Load previous file in directory OR scroll image up.",'{PgUp}'),
        ("ScrollDownOrNext","Scroll down OR next file","Load next file in directory OR scroll image down.",'{PgDown}'),
        ("ScrollToBeginOrFirstFile","Scroll to begin OR load first file","Scroll to begin (horizontal scroll) OR load first file in directory.",'{Home}'),
        ("ScrollToEndOrLastFile","Scroll to end OR load last file","Scroll to end (horizontal scroll) OR load last file in directory.",'{End}'),
    ),(#Tuple 6 - other actions
        #("ToggleAutSlideshow2","Pause/Resume automatic slideshow","Pause an automatic slideshow. Press this key again to resume the slideshow.",'{Pause}'),
        ("AppendToSlideshow","Append to current slideshow","Append current file to current slideshow.",'{F4}'),
        ("ToggleSlideshow","Fullscreen/Slideshow text display","Toggle fullscreen/slideshow text display.",'{N}'),
        #("StartDirSlideshow","Start directory slideshow","Start slideshow with current directory files.",'{Ctrl+W}'),
        ("ShowExifDialog","Show EXIF dialog","Show EXIF dialog for JPGs with available EXIF data.",'{E}'),
        ("ControlSwitchThumb","Control switch in thumbnail window","Control switch in the thumbnail window.",'{Ctrl+Tab}'),
        ("SwitchMainThumbnail","Switch main/thumbnail window","Switch between main and thumbnail window (if visible).",'{Tab}'),
        ("SelectAllThumb","Select all thumbnails","Select all thumbnails (thumbnail window).",'{Ctrl+A}'),
        ("OpenBrowseDialog",'Show "Browse-Subfolders" dialog.','Show "Browse-Subfolders" dialog.','{Ctrl+B}'),
        ("ShowIptcDialog","Show IPTC dialog","Show IPTC dialog for JPGs.",'{Ctrl+I}'),
        ("SendByMail","Send image by email","Send image by email.",'{Shift+M}'),
        ("CopyFilename","Copy filename to clipboard","Copy current filename to clipboard.",'{Shift+P}'),
        ("JumpIntoToolbar","Jump into toolbar edit field","Jump into the toolbar edit field.",'{Shift+T}'),
        ("Help","Help","Help.",'{F1}'),
        ("AboutIrfanView",'Show "About IrfanView" dialog','Show "About IrfanView" dialog.','{A}'),
    )
)

FindIrfanView = eg.WindowMatcher(
    'i_view32.exe', None, 'IrfanView', None, None, 1, False, 0.0, 0
)
