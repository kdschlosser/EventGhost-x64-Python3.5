...
WINDOWS = (
    (eg.ActionGroup, "Windows", "Windows", None, (
        ("MyMovies", "Show Movies Screen", "Show Movies screen.",
        "Activatewindow(MyVideoLibrary,movietitles,return)"),
        ("MyTVShows", "Show TV Shows Screen", "Show TV Shows screen.",
        "Activatewindow(MyVideoLibrary,tvshowtitles,return)"),
        ("ShutdownMen", "Show Shutdown Men", "Show the shutdown Menu.",
        ...
        ("Settings", "Settings", "WINDOW_SETTINGS_MENU",
        "Activatewindow(Settings)"),
        ("Music", "Music", "WINDOW_MUSIC", "Activatewindow(Music)"),
        ("Musicfiles", "Musicfiles", "WINDOW_MUSIC_FILES",
        "Activatewindow(Musicfiles)"),
        ("Musiclibrary", "Musiclibrary", "WINDOW_MUSIC_NAV",
        "Activatewindow(Musiclibrary)"),
        ("Musicplaylist", "Musicplaylist", "WINDOW_MUSIC_PLAYLIST",
        "Activatewindow(Musicplaylist)"),
        ("Musicplaylisteditor", "Musicplaylisteditor",
        "WINDOW_MUSIC_PLAYLIST_EDITOR", "Activatewindow(Musicplaylisteditor)"),
        ("Musicinformation", "Musicinformation", "WINDOW_DIALOG_MUSIC_INFO",
        "Activatewindow(Musicinformation)"),
        ("Video", "Video", "WINDOW_VIDEOS", "Activatewindow(Video)"),
        ("Videofiles", "Videofiles", "WINDOW_VIDEO_FILES",
        "Activatewindow(Videofiles)"),
        ("Videolibrary", "Videolibrary", "WINDOW_VIDEO_NAV",
        "Activatewindow(Videolibrary)"),
        ("Videoplaylist", "Videoplaylist", "WINDOW_VIDEO_PLAYLIST",
        "Activatewindow(Videoplaylist)"),
        ("Systeminfo", "Systeminfo", "WINDOW_SYSTEM_INFORMATION",
        "Activatewindow(Systeminfo)"),
        ("Guicalibration", "Guicalibration",
        "WINDOW_SCREEN_CALIBRATION\nbackward compat",
        "Activatewindow(Guicalibration)"),
        ("Screencalibration", "Screencalibration", "WINDOW_SCREEN_CALIBRATION",
        "Activatewindow(Screencalibration)"),
        ("Picturessettings", "Picturessettings", "WINDOW_SETTINGS_MYPICTURES",
        "Activatewindow(Picturessettings)"),
        ("Programssettings", "Programssettings", "WINDOW_SETTINGS_MYPROGRAMS",
        "Activatewindow(Programssettings)"),
        ("Weathersettings", "Weathersettings", "WINDOW_SETTINGS_MYWEATHER",
        "Activatewindow(Weathersettings)"),
        ("Musicsettings", "Musicsettings", "WINDOW_SETTINGS_MYMUSIC",
        "Activatewindow(Musicsettings)"),
        ("Systemsettings", "Systemsettings", "WINDOW_SETTINGS_SYSTEM",
        "Activatewindow(Systemsettings)"),
        ("Videossettings", "Videossettings", "WINDOW_SETTINGS_MYVIDEOS",
        "Activatewindow(Videossettings)"),
        ("Networksettings", "Networksettings", "WINDOW_SETTINGS_NETWORK",
        "Activatewindow(Networksettings)"),
        ("Appearancesettings", "Appearancesettings",
        "WINDOW_SETTINGS_APPEARANCE", "Activatewindow(Appearancesettings)"),
        ("Scripts", "Scripts", "WINDOW_PROGRAMS\nbackward compat",
        "Activatewindow(Scripts)"),
        ("Gamesaves", "Gamesaves", "Gamesaves", "Activatewindow(Gamesaves)"),
        ("Profiles", "Profiles", "WINDOW_SETTINGS_PROFILES",
        "Activatewindow(Profiles)"),
        ("Virtualkeyboard", "Virtualkeyboard", "WINDOW_DIALOG_KEYBOARD",
        "Activatewindow(Virtualkeyboard)"),
        ("Volumebar", "Volumebar", "WINDOW_DIALOG_VOLUME_BAR",
        "Activatewindow(Volumebar)"),
        ("Favourites", "Favourites", "WINDOW_DIALOG_FAVOURITES",
        "Activatewindow(Favourites)"),
        ("Musicosd", "Musicosd", "WINDOW_DIALOG_MUSIC_OSD",
        ...
        ("Videobookmarks", "Videobookmarks", "WINDOW_DIALOG_VIDEO_BOOKMARKS",
        "Activatewindow(Videobookmarks)"),
        (
        "Profilesettings", "Profilesettings", "WINDOW_DIALOG_PROFILE_SETTINGS",
        "Activatewindow(Profilesettings)"),
        ("Locksettings", "Locksettings", "WINDOW_DIALOG_LOCK_SETTINGS",
        "Activatewindow(Locksettings)"),
        (
        "Contentsettings", "Contentsettings", "WINDOW_DIALOG_CONTENT_SETTINGS",
        "Activatewindow(Contentsettings)"),
        ("Networksetup", "Networksetup", "WINDOW_DIALOG_NETWORK_SETUP",
        "Activatewindow(Networksetup)"),
        ...
        "Activatewindow(Smartplaylistrule)"),
        ("Movieinformation", "Movieinformation", "WINDOW_DIALOG_VIDEO_INFO",
        "Activatewindow(Movieinformation)"),
        ("Scriptsdebuginfo", "Scriptsdebuginfo", "Scriptsdebuginfo",
        "Activatewindow(Scriptsdebuginfo)"),
        ("Fullscreenvideo", "Fullscreenvideo", "WINDOW_FULLSCREEN_VIDEO",
        "Activatewindow(Fullscreenvideo)"),
        ("Visualisation", "Visualisation", "WINDOW_VISUALISATION",
        "Activatewindow(Visualisation)"),
        ("Slideshow", "Slideshow", "WINDOW_SLIDESHOW",
        "Activatewindow(Slideshow)"),
        ("Filestackingdialog", "Filestackingdialog",
        "WINDOW_DIALOG_FILESTACKING", "Activatewindow(Filestackingdialog)"),
        ("Weather", "Weather", "WINDOW_WEATHER", "Activatewindow(Weather)"),
        ("Screensaver", "Screensaver", "WINDOW_SCREENSAVER",
        "Activatewindow(Screensaver)"),
        ("Videoosd", "Videoosd", "WINDOW_DIALOG_VIDEO_OSD",
        "Activatewindow(Videoosd)"),
        ("Videomen", "Videomen", "WINDOW_VIDEO_MENU",
        "Activatewindow(Videomenu)"),
        ("Filebrowser", "Filebrowser", "WINDOW_DIALOG_FILE_BROWSER",
        "Activatewindow(Filebrowser)"),
        ("Startup", "Startup", "WINDOW_STARTUP_ANIM",
        "Activatewindow(Startup)"),
        ("Startwindow", "Startwindow", "WINDOW_START",
        "Activatewindow(Startwindow)"),
        ("Loginscreen", "Loginscreen", "WINDOW_LOGIN_SCREEN",
        "Activatewindow(Loginscreen)"),
        ("Musicoverlay", "Musicoverlay", "WINDOW_DIALOG_MUSIC_OVERLAY",
        "Activatewindow(Musicoverlay)"),
        ("Videooverlay", "Videooverlay", "WINDOW_DIALOG_VIDEO_OVERLAY",
        "Activatewindow(Videooverlay)"),
        ("Pictureinfo", "Pictureinfo", "WINDOW_DIALOG_PICTURE_INFO",
        "Activatewindow(Pictureinfo)"),
        ("Pluginsettings", "Pluginsettings", "Pluginsettings",
        "Activatewindow(Pluginsettings)"),
        ("Fullscreeninfo", "Fullscreeninfo", "WINDOW_DIALOG_FULLSCREEN_INFO",
        "Activatewindow(Fullscreeninfo)"),
        ("PlayerControls", "Player Controls", "WINDOW_DIALOG_PLAYER_CONTROLS",
...
GENERAL_ACTIONS = (
    (eg.ActionGroup, "General", "General", None, (
        ...
        ("PageUp", "PageUp",
        "Scroll up on page in a list, thumb, or text view.", "pageup"),
        ("PageDown", "PageDown",
        "Scroll down on page in a list, thumb, or text view.", "pagedown"),
        ("Select", "Select",
        "Select a button, or an item from a list of thumb view.", "select"),
        (
        "Highlight", "Highlight", "Highlight an item in a list or thumb view.",
        "highlight"),
        (
        'Parentfolder', 'Parentfolder', 'Go up a folder to the parent folder.',
        'parentfolder'),
        ('Back', 'Back', '', 'back'),
        ("ParentDir", "ParentDir",
        "Go up a folder to the parent folder.\n// backward compatibility",
        "parentdir"),
        ("PreviousMen", "PreviousMen", "Go back to the previous menu screen.",
        "previousmen"),
        ("Info", "Info",
        "Show the information about the currently highlighted item, or currently playing item.",
        "info"),
        (
        "Screenshot", "Screenshot", "Take a screenshot of the current screen.",
        "screenshot"),
        ("PowerOff", "PowerOff", "Shutdown and power off.", "poweroff"),
        ("VolumeUp", "VolumeUp", "Increase the volume of playback.",
        "volumeup"),
        ("VolumeDown", "VolumeDown", "Decrease the volume of playback.",
        "volumedown"),
        ("Mute", "Mute", "Mute the volume.", "mute"),
        ("ContextMen", "ContextMen", "Pops up a contextual men", "contextmen"),
        ("ScrollUp", "ScrollUp",
...
MEDIA_PLAYING_ACTIONS = (
    (eg.ActionGroup, "MediaPlaying", "Media playing", None, (
        ...
        ("Random", "Random", "Toggles random playback",
        "playercontrol(Random,Notify)"),
        ("Repeat", "Repeat", "Cycles through the repeat modes",
        "playercontrol(Repeat,Notify)"),
        ("UpdateVideoLibrary", "Update Video Library",
        "Update the video library.", "updatelibrary(video)"),
        ("UpdateMusicLibrary", "Update Music Library",
        "Update the music library.", "updatelibrary(music)"),
        ...
        "PlayDVD"),
        ("LastFMLove", "LastFM.Love",
        "Add the current playing last.fm radio track to the last.fm loved tracks",
        "LastFM.Love"),
        ("LastFMBan", "LastFM.Ban",
        "Ban the current playing last.fm radio track", "LastFM.Ban"),
    )),
)
...
PLAYLIST_ACTIONS = (
    (eg.ActionGroup, "Playlist", "Playlist", None, (
        ("Playlist", "Playlist",
        "Toggle to playlist view from My Music or My Videos", "playlist"),
        ("Queue", "Queue", "Queue the item to the current playlist", "queue"),
        ("MoveItemUp", "MoveItemUp", "Used to rearrange playlists",
        "moveitemup"),
        ("MoveItemDown", "MoveItemDown", "Used to rearrange playlists",
        "moveitemdown"),
    )),
)
...
FULLSCREEN_VIDEO_ACTIONS = (
    (eg.ActionGroup, "FullscreenVideo", "FullScreen Video", None, (
        ("StepForward", "StepForward", "Step forward 1% in the movie.",
        "stepforward"),
        ("StepBack", "StepBack", "Step back 1% in the movie.", "stepback"),
        ("BigStepForward", "BigStepForward", "Step forward 10% in the movie.",
        "bigstepforward"),
        ("BigStepBack", "BigStepBack", "Step back 10% in the movie.",
        "bigstepback"),
        ("SmallStepBack", "SmallStepBack",
        "Step back 7 seconds in the current video.", "smallstepback"),
        ...
        "Toggles whether subtitles are shown or not.", "showsubtitles"),
        ("NextSubtitle", "NextSubtitle",
        "Change to the next subtitle language, if there is more than one.",
        "nextsubtitle"),
        ('Subtitledelay', 'SubtitleDelay', 'Show subtitle delay slider',
        'subtitledelay'),
        ...
        "showtime"),
        ("ShowVideoMen", "ShowVideoMen",
        "Go to the DVD Video menu when playing a DVD.", "showvideomen"),
...
SLIDESHOW_ACTIONS = (
    (eg.ActionGroup, "PictureSlideshow", "Picture slideshow", None, (
        ...
        "Move to the next picture in a slideshow.", "nextpicture"),
        ("PreviousPicture", "PreviousPicture",
        "Move to the previous picture in a slideshow.", "previouspicture"),
        ("ZoomOut", "ZoomOut",
        ...
        "Normal (fullscreen) viewing in My Pictures", "zoomnormal"),
        ("ZoomLevel1", "ZoomLevel1", "Zoom to 120% in My Pictures",
        "zoomlevel1"),
        ("ZoomLevel2", "ZoomLevel2", "Zoom to 150% in My Pictures",
        "zoomlevel2"),
        ("ZoomLevel3", "ZoomLevel3", "Zoom to 200% in My Pictures",
        "zoomlevel3"),
        ("ZoomLevel4", "ZoomLevel4", "Zoom to 280% in My Pictures",
        "zoomlevel4"),
        ("ZoomLevel5", "ZoomLevel5", "Zoom to 400% in My Pictures",
        "zoomlevel5"),
        ("ZoomLevel6", "ZoomLevel6", "Zoom to 600% in My Pictures",
        "zoomlevel6"),
        ("ZoomLevel7", "ZoomLevel7", "Zoom to 900% in My Pictures",
        "zoomlevel7"),
        ("ZoomLevel8", "ZoomLevel8", "Zoom to 1350% in My Pictures",
        "zoomlevel8"),
        ("ZoomLevel9", "ZoomLevel9", "Zoom to 2000% in My Pictures",
        "zoomlevel9"),
...
CALIBRATION_ACTIONS = (
    (eg.ActionGroup, "ScreenCalibration", "Screen calibration", None, (
        ...
        "Used in Video + GUI calibration", "nextcalibration"),
        ("ResetCalibration", "ResetCalibration",
        "Used in Video + GUI calibration", "resetcalibration"),
        ("AnalogMove", "AnalogMove",
        "Move in the calibration screens, and while zoomed in My Pictures.",
        "analogmove"),
        ("NextResolution", "NextResolution", "Used in Video calibration",
        "nextresolution"),
    )),
)
...
ON_SCREEN_KEYBOARD_ACTIONS = (
    (eg.ActionGroup, "On-screenKeyboard", "On-screen keyboard", None, (
        ("BackSpace", "BackSpace",
        "Used in the virtual keyboards to delete one letter.", "backspace"),
        ("Shift", "Shift",
...
VISUALISATION_ACTIONS = (
    (eg.ActionGroup, "MusicVisualisation", "Music visualisation", None, (
        ...
        ("PreviousPreset", "PreviousPreset", "Previous visualisation preset",
        "previouspreset"),
        ("LockPreset", "LockPreset", "Lock the current visualisation preset",
        "lockpreset"),
        ("RandomPreset", "RandomPreset", "Switch to a new random preset",
        "randompreset"),
...
SHUTDOWN_ACTIONS = (
    (eg.ActionGroup, "ShutdownRelated", "Shutdown related", None, (
        ...
        "Trigger default Shutdown action defined in System Settings, Default Quit on Windows.",
        "shutdown"),
        ...
        ("Reboot", "Reboot Computer", "Cold reboots the system (power cycle).",
        "reboot"),
        ("Restart", "Restart Computer",
        "Cold reboots the system (power cycle).", "restart"),
    )),
)
...
UNCATEGORIZED_ACTIONS = (
    (eg.ActionGroup, "UncategorizedActions", "Uncategorized actions", None, (
        ...
        ("HideSubMen", "HideSubMen", "<depreciated>", "hidesubmen"),
        ...
        "Toggles watched/unwatched status for Videos", "togglewatched"),
        ...
        ('TakeScreenshot', 'TakeScreenshot', 'Takes a Screenshot',
        'TakeScreenshot'),
        ('ReloadSkin', 'ReloadSkin', "Reload XBMC's skin", 'ReloadSkin'),
        ('UnloadSkin', 'UnloadSkin', "Unload XBMC's skin", 'UnloadSkin'),
        ('RefreshRSS', 'RefreshRSS', 'Reload RSS feeds from RSSFeeds.xml',
        'RefreshRSS'),
        ('Playlist.Clear', 'Playlist.Clear', 'Clear the current playlist',
        'Playlist.Clear'),
        ('RipCD', 'RipCD', 'Rip the currently inserted audio CD', 'RipCD'),
        (
        'Skin.ResetSettings', 'Skin.ResetSettings', 'Resets all skin settings',
        'Skin.ResetSettings'),
        ('System.LogOff', 'System.LogOff', 'Log off current user',
        'System.LogOff'),
        ('Container.Refresh', 'Container.Refresh', 'Refresh current listing',
        'Container.Refresh'),
        ('Container.Update', 'Container.Update',
        'Update current listing. Send Container.Update(path,replace) to reset the path history',
        'Container.Update'),
        ('Container.NextViewMode', 'Container.NextViewMode',
        'Move to the next view type (and refresh the listing)',
        'Container.NextViewMode'),
        ('Container.PreviousViewMode', 'Container.PreviousViewMode',
        'Move to the previous view type (and refresh the listing)',
        'Container.PreviousViewMode'),
        ('Container.NextSortMethod', 'Container.NextSortMethod',
        'Change to the next sort method', 'Container.NextSortMethod'),
        ('Container.PreviousSortMethod', 'Container.PreviousSortMethod',
        'Change to the previous sort method', 'Container.PreviousSortMethod'),
        ('Container.SortDirection', 'Container.SortDirection',
        'Toggle the sort direction', 'Container.SortDirection'),
        ('UpdateAddonRepos', 'UpdateAddonRepos',
        'Check add-on repositories for updates', 'UpdateAddonRepos'),
        ('UpdateLocalAddons', 'UpdateLocalAddons',
        'Check for local add-on changes', 'UpdateLocalAddons'),
        (
        'ToggleDPMS', 'ToggleDPMS', 'Toggle DPMS mode manually', 'ToggleDPMS'),
        ('Weather.Refresh', 'Weather.Refresh', 'Force weather data refresh',
        'Weather.Refresh'),
        ('Weather.LocationNext', 'Weather.LocationNext',
        'Switch to next weather location', 'Weather.LocationNext'),
        ('Weather.LocationPrevious', 'Weather.LocationPrevious',
        'Switch to previous weather location', 'Weather.LocationPrevious'),
...
GAMEPAD_BUTTONS = (
    (eg.ActionGroup, "Gamepad", "Gamepad", None, (
        ...
        ("GamepadLeftThumbStickDown", "LeftThumbStickDown", "",
        "leftthumbstickdown"),
        ("GamepadLeftThumbStickLeft", "LeftThumbStickLeft", "",
        "leftthumbstickleft"),
        ("GamepadLeftThumbStickRight", "LeftThumbStickRight", "",
        "leftthumbstickright"),
        ("GamepadRightThumbStick", "RightThumbStick", "", "rightthumbstick"),
        ("GamepadRightThumbStickUp", "RightThumbStickUp", "",
        "rightthumbstickup"),
        ("GamepadRightThumbStickDown", "RightThumbStickDown", "",
        "rightthumbstickdown"),
        ("GamepadRightThumbStickLeft", "RightThumbStickLeft", "",
        "rightthumbstickleft"),
        ("GamepadRightThumbStickRight", "RightThumbStickRight", "",
        "rightthumbstickright"),
        ("GamepadLeftTrigger", "LeftTrigger", "", "lefttrigger"),
        ("GamepadRightTrigger", "RightTrigger", "", "righttrigger"),
        ("GamepadLeftAnalogTrigger", "LeftAnalogTrigger", "",
        "leftanalogtrigger"),
        ("GamepadRightAnalogTrigger", "RightAnalogTrigger", "",
        "rightanalogtrigger"),
...
APPLEREMOTE_BUTTONS = (
    (eg.ActionGroup, "AppleRemote", "AppleRemote", None, (
        ...
        ("AppleRemote13", "pageup",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        13),
        ("AppleRemote14", "pagedown",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        14),
        ("AppleRemote15", "pause",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        ...
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        17),
        ("AppleRemote18", "fast fwd",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        18),
        ("AppleRemote19", "rewind",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        19),
        ("AppleRemote20", "skip fwd",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        20),
        ("AppleRemote21", "skip back",
        "AppleRemote:\nAdditional buttons via Harmony Apple TV remote profile - these are also the learned buttons on Apple TV 2gen",
        21),
        ...
        ("AppleRemote73", "Previous",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 73),
        ("AppleRemote74", "Next",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 74),
        ("AppleRemote75", "Rewind",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 75),
        ("AppleRemote76", "Forward",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 76),
        ("AppleRemote77", "Return",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 77),
        ("AppleRemote78", "Enter",
        "AppleRemote:\nLearned remote buttons (ATV1 >2.3)", 78),

            # <!-- few gestures from Apple's iPhone Remote (ATV1 > 2.3 ?) -->
        ("AppleRemote80", "SwipeLeft",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        80),
        ("AppleRemote81", "SwipeRight",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        81),
        ("AppleRemote82", "SwipeUp",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        82),
        ("AppleRemote83", "SwipeDown",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        83),

        ("AppleRemote85", "FlickLeft",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        85),
        ("AppleRemote86", "FlickRight",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        86),
        ("AppleRemote87", "FlickUp",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        87),
        ("AppleRemote88", "FlickDown",
        "AppleRemote:\nfew gestures from Apple's iPhone Remote (ATV1 > 2.3 ?)",
        88),
    )),
)
...
class UpdateLibrary(eg.ActionBase):
    def __call__(self, libraryType="Video", updatePath=""):
        ...
        try:
            ...
            self.plugin.xbmc.send_action(
                "UpdateLibrary(" + str(parameterString) + ")")
        except:
            raise self.Exceptions.ProgramNotRunning
...
class BuiltInFunctions(eg.ActionBase):
    def __call__(self, Function="Help", Parameters=""):
        try:
            self.plugin.xbmc.send_action(
                Function + "(" + str(eg.ParseString(Parameters)) + ")")
        except:
            raise self.Exceptions.ProgramNotRunning
        ...
        def UpdateFunctions():
            def GetFunctions():
                try:
                    with contextlib.closing(urllib2.urlopen(urllib2.Request(
                        'https://raw.githubusercontent.com/xbmc/xbmc/Isengard/xbmc/interfaces/Builtins.cpp'))) as Builtinscpp:
                        Builtinslines = Builtinscpp.read().splitlines(False)
                except (urllib2.HTTPError, urllib2.URLError):
                    eg.PrintError(
                        'XBMC2: Error: Can\'t connect to "https://raw.githubusercontent.com/xbmc/xbmc/Isengard/xbmc/interfaces/Builtins.cpp" to update "BuiltInFunctions".')
                    raise
                else:
                    Builtinslist = Builtinslines[Builtinslines.index(
                        "const BUILT_IN commands[] = {") + 1:Builtinslines.index(
                        "};")]
                    ...
                    for Function in Builtinslist:
                        try:
                            FunctionList.append((
                            Function.strip(' {},').split(',')[0].strip('" '),
                            True if Function.strip(' {},').split(',')[1].strip(
                                '" ') == 'true' else False,
                            Function.strip(' {},').split(',')[2].strip('" ')))
                        except IndexError:
                            pass
                    return FunctionList
            ...
            def GetSyntax():
                def XMLText(Node):
                    ...
                    try:
                        for n in Node.childNodes:
                            text += n.nodeValue if n.nodeName == '#text' else XMLText(
                                n)
                        # print "Text:", text
                    except:
                    ...
                    try:
                        ...
                        eg.PrintError(
                            'XBMC2: Error: Can\'t connect to "http://kodi.wiki/view/List_of_built-in_functions" to update "BuiltInFunctions".')
                        raise
                    else:
                        Page2 = w.read()

                        ActionDict = {}
                        for table in xml.dom.minidom.parseString(
                            Page2).getElementsByTagName("table")[1:2]:
                            for tr in table.getElementsByTagName("tr"):
                                for code in tr.getElementsByTagName("code")[
                                0:1]:
                                    ActionDict[
                                        XMLText(code).strip().split('(')[
                                            0]] = (XMLText(code).strip(),
                                    XMLText(
                                        code.parentNode.nextSibling.nextSibling).strip())
                ...
                try:
                    ...
                    BuiltInFunctionList[
                        'Help'] = {'Syntax': 'Help', 'Description': "", 'Parameters': False}
                else:
                    try:
                        SyntaxList = GetSyntax()
                    except (urllib2.HTTPError, urllib2.URLError):
                        SyntaxList = {}
                    for Function, Parameters, Description in sorted(
                        FunctionsList):
                        try:
                            SyntaxList[Function]
                            ...
                            Syntax = Function
                        BuiltInFunctionList[
                            Function] = {'Syntax': Syntax, 'Description': Description, 'Parameters': Parameters}
		...
		"""
            ...
            def OnFunctionChange(event):
                if event.GetEventObject() == panel.combo_box_function:
                    if not \
                    BuiltInFunctionList[panel.combo_box_function.GetValue()][
                        'Parameters']:
                        panel.text_ctrl_parameters.Disable()
                    else:
                        panel.text_ctrl_parameters.Enable()
                    panel.text_ctrl_syntax.SetValue(BuiltInFunctionList[
                        panel.combo_box_function.GetValue()]['Syntax'])
                    panel.label_description.SetLabel(BuiltInFunctionList[
                        panel.combo_box_function.GetValue()]['Description'])

            def initPanel(self):
                self.combo_box_function = wx.ComboBox(self, wx.ID_ANY,
                    value=Function, choices=sorted(BuiltInFunctionList.keys()),
                    style=wx.CB_READONLY)
                self.sizer_function_staticbox = wx.StaticBox(self, wx.ID_ANY,
                    "Function")
                self.label_left = wx.StaticText(self, wx.ID_ANY, "(")
                self.text_ctrl_parameters = wx.TextCtrl(self, wx.ID_ANY,
                    Parameters)
                self.label_right = wx.StaticText(self, wx.ID_ANY, ")")
                self.sizer_parameter_staticbox = wx.StaticBox(self, wx.ID_ANY,
                    "Parameter(s)")
                self.text_ctrl_syntax = wx.TextCtrl(self, wx.ID_ANY,
                    BuiltInFunctionList[Function]['Syntax'],
                    style=wx.TE_READONLY | wx.BORDER_NONE)
                self.sizer_syntax_staticbox = wx.StaticBox(self, wx.ID_ANY,
                    "Syntax")
                self.label_description = wx.TextCtrl(self, wx.ID_ANY,
                    BuiltInFunctionList[Function]['Description'],
                    style=wx.TE_MULTILINE | wx.TE_READONLY | wx.BORDER_NONE | wx.TE_RICH)
                self.sizer_description_staticbox = wx.StaticBox(self,
                ...
                self.Bind(wx.EVT_COMBOBOX, OnFunctionChange,
                    self.combo_box_function)
                self.button_update.Bind(wx.EVT_BUTTON, OnUpdate)

            def setPanelProperties(self):
                self.label_left.SetFont(
                    wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
                self.label_right.SetFont(
                    wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
                self.button_update.SetToolTipString(
                    "Update \"BuiltInFunctions\" form Kodis website.")

            def doPanelLayout(self):
                sizer_main = wx.BoxSizer(wx.VERTICAL)
                self.sizer_description_staticbox.Lower()
                sizer_description = wx.StaticBoxSizer(
                    self.sizer_description_staticbox, wx.HORIZONTAL)
                self.sizer_syntax_staticbox.Lower()
                sizer_syntax = wx.StaticBoxSizer(self.sizer_syntax_staticbox,
                    wx.HORIZONTAL)
                sizer_functionparameter = wx.BoxSizer(wx.HORIZONTAL)
                self.sizer_parameter_staticbox.Lower()
                sizer_parameter = wx.StaticBoxSizer(
                    self.sizer_parameter_staticbox, wx.HORIZONTAL)
                self.sizer_function_staticbox.Lower()
                sizer_function = wx.StaticBoxSizer(
                    self.sizer_function_staticbox, wx.HORIZONTAL)
            ...
            while panel.Affirmed():
                panel.SetResult(str(panel.combo_box_function.GetValue()),
                    str(panel.text_ctrl_parameters.GetValue()))


class ButtonPrototype(eg.ActionClass):
    def __call__(self):
        try:
            packet = PacketBUTTON(map_name=str("R1"),
                button_name=str(self.value), repeat=0)
            packet.send(self.plugin.xbmc.sock, self.plugin.xbmc.addr,
                self.plugin.xbmc.uid)
        except:
            raise self.Exceptions.ProgramNotRunning
...
class GamepadPrototype(eg.ActionClass):
    def __call__(self):
        try:
            packet = PacketBUTTON(map_name=str("XG"),
                button_name=str(self.value), repeat=0)
            packet.send(self.plugin.xbmc.sock, self.plugin.xbmc.addr,
                self.plugin.xbmc.uid)
        except:
...
class AppleRemotePrototype(eg.ActionClass):
    def __call__(self):
        try:
            packet = PacketBUTTON(map_name=str("JS0:AppleRemote"),
                code=self.value, repeat=0)
            packet.send(self.plugin.xbmc.sock, self.plugin.xbmc.addr,
                self.plugin.xbmc.uid)
        except:
            raise self.Exceptions.ProgramNotRunning
...
class KeyboardPrototype(eg.ActionClass):
    def __call__(self):
        try:
            packet = PacketBUTTON(map_name=str("KB"),
                button_name=str(self.value), repeat=0)
            packet.send(self.plugin.xbmc.sock, self.plugin.xbmc.addr,
                self.plugin.xbmc.uid)
        except:
...
class XBMC_HTTP_API:
    ...
    def send(self, method, params=""):
        request = urllib2.Request(
            'http://' + self.ip + ':' + self.port + '/xbmcCmds/xbmcHttp?command=' + method + '(' + urllib2.quote(
                eg.ParseString(params), ':\\') + ')')
            ...
            if (''.join(responce).find('<html>') != -1):
                ...
                for lines in responce:
                    if (lines.find('<html>') != -1):
                        lines = lines[lines.find('<html>') + 6:]
                    if (lines.find('</html>') != -1):
                        lines = lines[:lines.find('</html>')]
                    if (lines.find('<li>') != -1):
                        if (lines.find('OK') != -1):
                            responce2 = 'OK'
...
class XBMC_JSON_RPC:
    ...
    def send(self, method, params=None, wait=True):
        ...
        request = urllib2.Request(
            'http://' + self.ip + ':' + self.port + '/jsonrpc',
        ...
        try:
            ...
            responce = urllib2.urlopen(request,
                timeout=(60 if wait else 1)).read()
    ...
    def __call__(self):
        ...
        if (responce != None):
            ...
            if Method:
                print('Method: ', Method)
                if (Method != 'Picture'):
                    responce = self.plugin.JSON_RPC.send(
                        Method + 'Playlist.GetItems')
                    #					print 'eg.result: ', responce['items'][responce['current']]['file']
                    return \
                    responce['result']['items'][responce['result']['current']][
                        'file']
                else:
...
class SendNotification(eg.ActionClass):
    ...
    def __call__(self, title, message):
        try:
            self.plugin.xbmc.send_notification(str(eg.ParseString(title)),
                str(eg.ParseString(message)))
...
#				print 'Failed to open: httpapi.dat'
        ...
        def OnCommandChange(event):
            if event.GetEventObject() == comboBoxControl:
                syntax.SetLabel(
                    httpapi.Commands[HBoxControl.GetSelection()][1][
                        event.GetSelection()])
                description.SetLabel(
                    httpapi.Commands[HBoxControl.GetSelection()][2][
                        event.GetSelection()])
        ...
        def UpdateCommands():
            ...
            try:
                doc = xml.dom.minidom.parseString(urllib2.urlopen(
                    urllib2.Request(
                        'http://kodi.wiki/view/Web_Server_HTTP_API')).read())
            except (urllib2.HTTPError, urllib2.URLError):
                print("Connect error")
            else:
                    ...
                    for node2 in node.getElementsByTagName("tr")[1:]:
                        ...
                        for node4 in node3.childNodes:
                            if node4.nodeType == Node.TEXT_NODE:
                                ...
                                Pos = Text.find('(')
                                if (Pos != -1):
                                    httpapi.Commands[Header][0].append(
                                        Text[:Pos])
                                else:
                                    httpapi.Commands[Header][0].append(Text)
                            else:
                                print('<' + node4.tagName + '>')
                        httpapi.Commands[Header][2].append(GetText(
                            node2.getElementsByTagName("td")[1]).strip())
                    Header += 1
                try:
                    writeData('httpapi.dat',
        ...
        panel = eg.ConfigPanel()
        HBoxControl = wx.ComboBox(panel, -1, value=httpapi.Headers[category],
            choices=httpapi.Headers, style=wx.CB_READONLY)
        comboBoxControl = wx.ComboBox(panel, -1, value=command,
            choices=httpapi.Commands[category][0])
        ...
        panel.sizer.Add(wx.StaticText(panel, -1,
            "Choose or type in a HTTP API command and add parameter(s)"))
        ...
        if (comboBoxControl.GetSelection() != -1):
            syntax = wx.TextCtrl(panel, -1,
                httpapi.Commands[category][1][comboBoxControl.GetSelection()],
                (1, 70), size=(500, -1), style=wx.TE_READONLY)
        else:
            syntax = wx.TextCtrl(panel, -1, '', (1, 70), size=(500, -1),
                style=wx.TE_READONLY)
        panel.sizer.Add(syntax)
        panel.sizer.Add(
            wx.StaticBox(panel, -1, 'Command description:', size=(500, 150)))
        if (comboBoxControl.GetSelection() != -1):
            description = wx.StaticText(panel, -1,
                httpapi.Commands[category][2][comboBoxControl.GetSelection()],
                (5, 105), style=wx.ALIGN_LEFT)
        else:
            description = wx.StaticText(panel, -1, '', (5, 105),
                style=wx.ALIGN_LEFT)
        description.Wrap(480)
        ...
        while panel.Affirmed():
            panel.SetResult(comboBoxControl.GetValue(),
                textControl1.GetValue(), HBoxControl.GetSelection(),
                CheckBox.GetValue())
...
def readData(filename):
    try:
        with open(
            os.path.join(eg.folderPath.RoamingAppData, 'EventGhost', 'plugins',
                'XBMC2', filename), 'rb') as f:
...
class JSONRPC(eg.ActionClass):
    ...
    def __call__(self, method="JSONRPC.Introspect", param="", log=True,
        ...
        if param:
            responce = self.plugin.JSON_RPC.send(method,
                ast.literal_eval(ParseString2(param)), wait=wait)
        else:
        ...
        if responce != None:
            if responce.has_key('noresult'):
                ...
                if log:
                    print('Result:\n',
                        json.dumps(responce['result'], sort_keys=True,
                            indent=2))
    ...
    def Configure(self, method="JSONRPC.Introspect", param="", log=True,
        ...
        def OnUpdate(event):
            UpdateMethods()
            try:
                jsonrpc.Namespaces, jsonrpc.Methods, jsonrpc.Descriptions = readData(
                    'jsonrpc.dat')
            except IOError:
                pass
            else:
        ...
        def UpdateMethods():
            ...
            if responce:
                ...
                if responce['result']['version'] > 2:
                    responce = self.plugin.JSON_RPC.send('JSONRPC.Introspect',
                        json.loads('{"filterbytransport": false}'))
                    if responce != None:
                        if responce.has_key('result'):
                            for method in responce['result']['methods']:
                                ...
                                jsonrpc.Methods[namespace].append(
                                    method[method.find('.') + 1:])
                                if responce['result']['methods'][
                                    method].has_key('description'):
                                    jsonrpc.Descriptions[namespace].append(
                                        responce['result']['methods'][method][
                                            'description'])
                                else:
                                    jsonrpc.Descriptions[namespace].append('')
                            try:
                                writeData('jsonrpc.dat', (
                                jsonrpc.Namespaces, jsonrpc.Methods,
                                jsonrpc.Descriptions))
                            except IOError:
                                pass
                            return False
                            ...
                            #					print 'Got bad JSON-RPC responce', responce
                            eg.PrintError('Got bad JSON-RPC responce',
                                responce)
                            return False
                    else:
                        return False
                    ...
                    responce = self.plugin.JSON_RPC.send('JSONRPC.Introspect',
                        json.loads(
                            '{"getdescriptions": true, "getpermissions": false}'))
                    if responce != None:
                        if responce.has_key('result'):
                            for method in responce['result']['commands']:
                                namespace = method['command'][
                                :method['command'].find('.')]
                                if namespace not in jsonrpc.Namespaces:
                                    jsonrpc.Namespaces.append(namespace)
                                    jsonrpc.Methods[namespace] = []
        ...
        def OnMethodChange(event):
            if event.GetEventObject() == comboBoxControl:
                description.SetLabel(jsonrpc.Descriptions[
                    jsonrpc.Namespaces[HBoxControl.GetSelection()]][
                    event.GetSelection()])
                description.Wrap(480)
            else:
        ...
        try:
            ...
            UpdateMethods()
        HBoxControl = wx.ComboBox(panel, -1, value=method[:method.find('.')],
            choices=jsonrpc.Namespaces, style=wx.CB_READONLY)
        comboBoxControl = wx.ComboBox(panel, -1,
            value=method[method.find('.') + 1:], choices=jsonrpc.Methods[
                jsonrpc.Namespaces[HBoxControl.GetSelection()]],
            style=wx.CB_READONLY)
        ...
        Category.Add(comboBoxControl)
        panel.sizer.Add(wx.StaticText(panel, -1,
            "Choose a JSON-RPC Method and add any parameter(s)"))
        panel.sizer.Add(Category)
        panel.sizer.Add(textControl2)
        panel.sizer.Add(
            wx.StaticBox(panel, -1, 'Method description:', size=(500, 150)))
        if (comboBoxControl.GetSelection() != -1):
            description = wx.StaticText(panel, -1, jsonrpc.Descriptions[
                jsonrpc.Namespaces[HBoxControl.GetSelection()]][
                comboBoxControl.GetSelection()], (5, 70), style=wx.ALIGN_LEFT)
        else:
            description = wx.StaticText(panel, -1, '', (5, 70),
                style=wx.ALIGN_LEFT)
        description.Wrap(480)
        Bottom = wx.BoxSizer(wx.HORIZONTAL)
        CheckBox = wx.CheckBox(panel, -1, 'Show result in the log')
        ...
        while panel.Affirmed():
            ...
            panel.SetResult(
                HBoxControl.GetValue() + '.' + comboBoxControl.GetValue(),
                textControl2.GetValue(), CheckBox.GetValue(),
                CheckBox2.GetValue())
    ...
    for result in ssdpResultList:
        ...
        for modelName in doc.getElementsByTagName("modelName"):
            if modelName.firstChild.data in ('XBMC Media Center', 'Kodi'):
                XBMCResultList[urlparse(
                    doc.getElementsByTagName("presentationURL")[
                        0].firstChild.data).netloc] = \
                doc.getElementsByTagName("friendlyName")[0].firstChild.data
...
class XBMC2(eg.PluginClass):
    ...
    def __init__(self):
        super(XBMC2, self).__init__()
        ButtonsGroup = self.AddGroup("Buttons",
            "Button actions to send to XBMC")
        ...
        ButtonsGroup.AddActionsFromList(APPLEREMOTE_BUTTONS,
            AppleRemotePrototype)
        ...
        ActionsGroup.AddActionsFromList(FULLSCREEN_VIDEO_ACTIONS,
            ActionPrototype)
        ...
        ActionsGroup.AddActionsFromList(ON_SCREEN_KEYBOARD_ACTIONS,
            ActionPrototype)
        ...
        try:
            MANUALLYUPDATED_ACTIONS = [
                [eg.ActionGroup, "ManuallyUpdated", "Manually Updated", None,
                    readData('actions.dat')]]
        except IOError:
            # eg.PrintError('Failed to open: httpapi.dat')
            pass
        else:
            ActionsGroup.AddActionsFromList(MANUALLYUPDATED_ACTIONS,
                ActionPrototype)

        ConfigurableGroup = ActionsGroup.AddGroup("Configurable",
            "Actions that have configurable settings")
    ...
    def Configure(self, pluginConfig={}, *args):
        def UpdateActions(event):
            def GetActions():
                ...
                Page1a = Page1[Page1.index(
                    "static const ActionMapping actions[] =") + 2:Page1.index(
                    "};")]
                # print Page1a[0]
                # print len(Page1a)
            ...
            def GetActionDescriptions():
                ...
                ActionDict = {}
                for tr in xml.dom.minidom.parseString(
                    Page2).getElementsByTagName("tr"):
                    ...
                    for code in tr.getElementsByTagName("code")[0:1]:
                        ...
                        if '2-9' in XMLText(code).strip():
                            for i in range(2, 10):
                                ...
                                ActionDict[(XMLText(code).strip()[:-5] + str(
                                    i)).lower()] = (
                                (XMLText(code).strip()[:-5] + str(i)), XMLText(
                                    code.parentNode.nextSibling.nextSibling).strip())
                            ...
                            if XMLText(code).strip().lower() not in ActionDict:
                                ...
                                # print repr(XMLText(code.parentNode.nextSibling.nextSibling).strip())
                                ActionDict[XMLText(code).strip().lower()] = (
                                XMLText(code).strip(), XMLText(
                                    code.parentNode.nextSibling.nextSibling).strip())
                # print "End"
                return ActionDict
            ...
            for a in GENERAL_ACTIONS[0][4] + MEDIA_PLAYING_ACTIONS[0][4] + \
                     PLAYLIST_ACTIONS[0][4] + FULLSCREEN_VIDEO_ACTIONS[0][4] + \
                     SLIDESHOW_ACTIONS[0][4] + CALIBRATION_ACTIONS[0][4] + \
                     FILEMANAGER_ACTIONS[0][4] + ON_SCREEN_KEYBOARD_ACTIONS[0][
                         4] + VISUALISATION_ACTIONS[0][4] + \
                     SHUTDOWN_ACTIONS[0][4] + UNCATEGORIZED_ACTIONS[0][4]:
                # print a
            ...
            for action in sorted(ActionList):
                try:
                    ...
                    EGActionList.append((
                    action, ActionDict[action][0], ActionDict[action][1],
                    action))
                except KeyError:
            ...
            print(
                'XBMC2: "Manually added" actions updated, restart EventGhost to use.')

        def ConnectionTest(event):
            print(
                "XBMC2: Starting connection test, trying to connect to XBMC using",
                panel.combo_box_IP.GetValue())

            self.JSON_RPC.connect(
                ip=panel.combo_box_IP.GetValue().split(':')[0],
                port=panel.combo_box_IP.GetValue().split(':')[1],
                username=panel.text_ctrl_Username.GetValue(),
                password=panel.text_ctrl_Password.GetValue())
            try:
                result = self.JSON_RPC.send('GUI.ShowNotification',
                    ast.literal_eval(
                        "['XBMC2 for EventGhost','Connection test, JSON-RPC works.']"))
            except urllib2.HTTPError as e:
                eg.PrintError('XBMC2:', str(e))
                print(
                    'XBMC2: Please check that your username and password are correct.')
            except urllib2.URLError as e:
                eg.PrintError('XBMC2:', str(e.reason))
                print(
                    'XBMC2: Please check that XBMC is running, that your IP address and port are correct.\nXBMC2: Also in XBMCs settings\\Services\\Webserver, "Allow control of XBMC via HTTP" needs to be set.')
            except ValueError as e:
                eg.PrintError(
                    "XBMC2: Server responded but didn't provide valid JSON data. Check that your IP and port are correct.")
            except:
            ...
            #	eg.PrintError('XBMC2: JSON-RPC error: ', str(result['error']['message']))
                ...
                self.HTTP_API.connect(
                    ip=panel.combo_box_IP.GetValue().split(':')[0],
                    port=panel.combo_box_IP.GetValue().split(':')[1],
                    username=panel.text_ctrl_Username.GetValue(),
                    password=panel.text_ctrl_Password.GetValue())
                try:
                    result = self.HTTP_API.send('ExecBuiltIn',
                        'Notification(XBMC2 for EventGhost, Connection test. HTTPAPI works.)')
                except urllib2.HTTPError as e:
                    if e.code == 401:
                        eg.PrintError('XBMC2:', str(e))
                        print(
                    ...
                    if result == 'OK':
                        ...
                        self.xbmc.connect(
                            ip=panel.combo_box_IP.GetValue().split(':')[0])
                        self.xbmc.send_notification('XBMC2 for EventGhost',
                            'Connection test, if you see this your IP address is correct.')
                        self.xbmc.close()
                finally:
                    self.HTTP_API.close()
        ...
        def initPanel(self):
            self.combo_box_IP = wx.ComboBox(self, wx.ID_ANY,
                value=pluginConfig['XBMC']['ip'] + ':' + str(
                    pluginConfig['XBMC']['port']), choices=["127.0.0.1:80"],
                style=wx.CB_DROPDOWN)
            self.button_IPTest = wx.Button(self, wx.ID_ANY, "Test")

            self.button_UpdateActions = wx.Button(self, wx.ID_ANY,
                "Update Actions")
            ...
            self.text_ctrl_Username = wx.TextCtrl(self, wx.ID_ANY,
                pluginConfig['XBMC']['username'])
            self.label_Password = wx.StaticText(self, wx.ID_ANY, "Password")
            self.text_ctrl_Password = wx.TextCtrl(self, wx.ID_ANY,
                pluginConfig['XBMC']['password'], style=wx.TE_PASSWORD)
            self.sizer_Global_staticbox = wx.StaticBox(self, wx.ID_ANY,
                "IP address and port of XBMC (127.0.01 is this computer)")
            self.checkbox_EventServerEnable = wx.CheckBox(self, wx.ID_ANY,
                "Enable")
            self.label_EventServerPort = wx.StaticText(self, wx.ID_ANY, "Port")
            self.spin_ctrl_EventServerPort = wx.SpinCtrl(self, wx.ID_ANY,
                str(pluginConfig['EventServer']['port']), min=0, max=65535)
            self.sizer_EventServer_staticbox = wx.StaticBox(self, wx.ID_ANY,
                "EventServer")
            self.checkbox_JSONRPCEnable = wx.CheckBox(self, wx.ID_ANY,
                "Enable")
            self.label_Port = wx.StaticText(self, wx.ID_ANY, "Port")
            self.spin_ctrl_JSONRPCPort = wx.SpinCtrl(self, wx.ID_ANY,
                str(pluginConfig['JSONRPC']['port']), min=0, max=65535)
            self.label_Retrys = wx.StaticText(self, wx.ID_ANY, "Retrys")
            self.spin_ctrl_Retrys = wx.SpinCtrl(self, wx.ID_ANY, "5", min=0,
                max=100)
            self.label_Time = wx.StaticText(self, wx.ID_ANY,
                "Time between retrys")
            self.spin_ctrl_Time = wx.SpinCtrl(self, wx.ID_ANY, "5", min=0,
                max=100)
            self.label_Seconds = wx.StaticText(self, wx.ID_ANY, "Seconds")
            self.sizer_JSONRPC_staticbox = wx.StaticBox(self, wx.ID_ANY,
                "JSON-RPC notifications")
            self.checkbox_BroadcastEnable = wx.CheckBox(self, wx.ID_ANY,
                "Enable")
            self.label_BroadcastPort = wx.StaticText(self, wx.ID_ANY, "Port")
            self.spin_ctrl_BroadcastPort = wx.SpinCtrl(self, wx.ID_ANY,
                str(pluginConfig['Broadcast']['port']), min=0, max=65535)
            self.checkbox_BroadcastWorkaround = wx.CheckBox(self, wx.ID_ANY,
                "Repeating events workaround")
            self.sizer_Broadcast_staticbox = wx.StaticBox(self, wx.ID_ANY,
                "Broadcast events")
            self.checkbox_logRawEvents = wx.CheckBox(self, wx.ID_ANY,
                "Log raw events")

            self.checkbox_logDebug = wx.CheckBox(self, wx.ID_ANY, "Debug")

            self.sizer_Events_staticbox = wx.StaticBox(self, wx.ID_ANY,
                "Event settings")
        ...
        def setPanelProperties(self):
            ...
            self.combo_box_IP.SetToolTipString(
                "IP address of the XBMC you want to control.")
            self.button_IPTest.SetToolTipString("Test to connect to XBMC")

            self.button_UpdateActions.SetToolTipString(
                'Add any new XBMC actions to a category "Manually Updated". You need to restart EventGhost for the new actions to be visible')

            self.button_Search.SetToolTipString(
                "Search for any XBMCs that are running and reachable over the LAN.")
            self.text_ctrl_Username.SetToolTipString(
                "Username that are specified in XBMC")
            self.text_ctrl_Password.SetToolTipString(
                "Password that are specified in XBMC")
            ...
            self.spin_ctrl_EventServerPort.SetToolTipString(
                "Port used by XBMC to recieve notifications")
            self.checkbox_JSONRPCEnable.SetToolTipString(
                "Enable JSON-RPC notifications")
            self.checkbox_JSONRPCEnable.SetValue(
                pluginConfig['JSONRPC']['enable'])
            self.checkbox_BroadcastEnable.SetValue(
                pluginConfig['Broadcast']['enable'])
            ...
            self.spin_ctrl_JSONRPCPort.SetToolTipString(
                "Port used by XBMC to recieve notifications")
            self.spin_ctrl_Retrys.SetMinSize((50, -1))
            self.spin_ctrl_Time.SetMinSize((50, -1))
            self.checkbox_logRawEvents.SetToolTipString(
                "Show any events from XBMC in the log, exactly as XBMC sends them.")

            self.checkbox_logDebug.SetToolTipString(
                "Activate debugging messages in the log(Will spam the log so use only when needed).")

        def doPanelLayout(self):
            self.sizer = wx.BoxSizer(wx.VERTICAL)
            self.sizer_Events_staticbox.Lower()
            sizer_Events = wx.StaticBoxSizer(self.sizer_Events_staticbox,
                wx.VERTICAL)
            self.sizer_Broadcast_staticbox.Lower()
            sizer_Broadcast = wx.StaticBoxSizer(self.sizer_Broadcast_staticbox,
                wx.HORIZONTAL)
            ...
            sizer_JSONRPC = wx.StaticBoxSizer(self.sizer_JSONRPC_staticbox,
                wx.VERTICAL)
            sizer_14 = wx.BoxSizer(wx.HORIZONTAL)
            sizer_2 = wx.BoxSizer(wx.HORIZONTAL)
            self.sizer_EventServer_staticbox.Lower()
            sizer_EventServer = wx.StaticBoxSizer(
                self.sizer_EventServer_staticbox, wx.VERTICAL)
            sizer_1 = wx.BoxSizer(wx.HORIZONTAL)
            self.sizer_Global_staticbox.Lower()
            sizer_Global = wx.StaticBoxSizer(self.sizer_Global_staticbox,
                wx.VERTICAL)
        ...
        while panel.Affirmed():
            changed = False
            if pluginConfig['XBMC']['ip'] != \
                panel.combo_box_IP.GetValue().split(':')[0]:
                pluginConfig['XBMC']['ip'] = \
                panel.combo_box_IP.GetValue().split(':')[0]
                changed = True
            if pluginConfig['XBMC']['port'] != int(
                panel.combo_box_IP.GetValue().split(':')[1]):
                pluginConfig['XBMC']['port'] = int(
                    panel.combo_box_IP.GetValue().split(':')[1])
                changed = True
            if pluginConfig['XBMC'][
                'username'] != panel.text_ctrl_Username.GetValue():
                pluginConfig['XBMC'][
                    'username'] = panel.text_ctrl_Username.GetValue()
                changed = True
            if pluginConfig['XBMC'][
                ...
                pluginConfig['XBMC'][
                    'password'] = panel.text_ctrl_Password.GetValue()
                changed = True
            if pluginConfig['EventServer']['port'] != int(
                panel.spin_ctrl_EventServerPort.GetValue()):
                pluginConfig['EventServer']['port'] = int(
                    panel.spin_ctrl_EventServerPort.GetValue())
                changed = True
            if pluginConfig['JSONRPC'][
                'enable'] != panel.checkbox_JSONRPCEnable.GetValue():
                pluginConfig['JSONRPC'][
                    'enable'] = panel.checkbox_JSONRPCEnable.GetValue()
                changed = True
            if pluginConfig['JSONRPC']['port'] != int(
                panel.spin_ctrl_JSONRPCPort.GetValue()):
                pluginConfig['JSONRPC']['port'] = int(
                    panel.spin_ctrl_JSONRPCPort.GetValue())
                changed = True
            if pluginConfig['Broadcast'][
                'enable'] != panel.checkbox_BroadcastEnable.GetValue():
                pluginConfig['Broadcast'][
                    'enable'] = panel.checkbox_BroadcastEnable.GetValue()
                changed = True
            if pluginConfig['Broadcast']['port'] != int(
                panel.spin_ctrl_BroadcastPort.GetValue()):
                pluginConfig['Broadcast']['port'] = int(
                    panel.spin_ctrl_BroadcastPort.GetValue())
                changed = True
            if pluginConfig[
                'logRawEvents'] != panel.checkbox_logRawEvents.GetValue():
                pluginConfig[
                    'logRawEvents'] = panel.checkbox_logRawEvents.GetValue()
                changed = True
    ...
    def __start__(self, pluginConfig={}, *args):
        ...
        try:
            self.xbmc.connect(ip=pluginConfig['XBMC']['ip'],
                port=pluginConfig['EventServer']['port'])
        except:
            raise self.Exceptions.ProgramNotRunning
        self.JSON_RPC.connect(ip=pluginConfig['XBMC']['ip'],
            port=pluginConfig['XBMC']['port'],
            username=pluginConfig['XBMC']['username'],
            password=pluginConfig['XBMC']['password'])
        self.HTTP_API.connect(ip=pluginConfig['XBMC']['ip'],
            port=pluginConfig['XBMC']['port'],
            username=pluginConfig['XBMC']['username'],
            password=pluginConfig['XBMC']['password'])
        if self.pluginConfig['JSONRPC']['enable']:
            try:
                ...
                self.JSONRPCNotificationsThread = Thread(
                    target=self.JSONRPCNotifications,
                    args=(self.stopJSONRPCNotifications,))
                ...
                if not self.JSONRPCNotificationsThread.isAlive():
                    ...
                    print(
                        "XBMC2: Can't stop old JSON-RPC notification thread, will not start a new one.")

        if self.pluginConfig['Broadcast']['enable']:
            self.stopBroadcastEvents.clear()
            BroadcastEventsThread = Thread(target=self.BroadcastEvents,
                args=(self.stopBroadcastEvents,))
    ...
    def JSONRPCNotifications(self, stopJSONRPCNotifications):
        ...
        def SSDPInit(SSDP_IP, SSDP_PORT):
            ...
            sock.settimeout(10)
            sock.bind(('', SSDP_PORT))
            mreq = struct.pack("4sl", socket.inet_aton(SSDP_IP),
                socket.INADDR_ANY)
            ...
            try:
                ...
                try:
                    ...
                    mreq = socket.inet_aton(SSDP_IP) + socket.inet_aton(
                        INTERFACE_ADDR)
            ...
            while not (stopJSONRPCNotifications.isSet() or XBMCDetected):
                ...
                # headers = Headers(sock.recv(4096))
                    ...
                    try:
                        if debug:
                            with open(
                                os.path.join(eg.folderPath.RoamingAppData,
                                    'EventGhost', 'plugins', 'XBMC2',
                                    'ssdp.log'), 'a+') as f:
                                f.write("Got ssdp message.")
                        if "NOTIFY * HTTP/1.1" == headers['Start-line']:
                            try:
                                if headers['USN'].split(':', 2)[
                                    1] not in USNCache:
                                    try:
                                        ...
                                        for modelName in doc.getElementsByTagName(
                                            "modelName"):
                                            if modelName.firstChild.data in (
                                            'Kodi', 'XBMC Media Center',
                                            'XBMC'):
                                                if debug:
                                                    with open(os.path.join(
                                                        eg.folderPath.RoamingAppData,
                                                        'EventGhost',
                                                        'plugins', 'XBMC2',
                                                        'ssdp.log'),
                                                        'a+') as f:
                                                        ...
                                                        f.write(
                                                            urllib2.urlopen(
                                                                headers[
                                                                    'LOCATION']).read())
                                                    print(
                                                        'XBMC2: SSDP modelName:',
                                                        modelName.firstChild.data)
                                                # from urlparse import urlparse
                                                if self.pluginConfig['XBMC'][
                                                    'ip'] == '127.0.0.1':
                                                    for ip in interface_addresses():
                                                        ...
                                                        if urlparse(
                                                            doc.getElementsByTagName(
                                                                "presentationURL")[
                                                                0].firstChild.data).netloc.split(
                                                            ":")[0] == ip:
                                                            try:
                                                                if urlparse(
                                                                    doc.getElementsByTagName(
                                                        ...
                                                        f.write(
                                                            urllib2.urlopen(
                                                                headers[
                                                                    'LOCATION']).read())
                                                    print(
                                                        'XBMC2: SSDP unknown modelName:',
                                                        modelName.firstChild.data)
                                        USNCache.append(
                                            headers['USN'].split(':', 2)[1])
                            except IndexError:
                                if debug:
                                    print('XBMC2: SSDP: No USN in headers:',
                                        headers)
                                continue
                            ...
                            if 'Kodi' in headers['USER-AGENT']:
                                if debug:
                                    print(
                                        'XBMC2: SSDP: Found search message from Kodi:',
                                        headers['USER-AGENT'])
                                XBMCDetected = True
                                break
                    except KeyError:
                        if debug:
                            print(
                                'XBMC2: SSDP: "Start-line" test failed: Content of headers:',
                                headers)
                            eg.PrintError('JSON-RPC connect error: ')
                            import sys, traceback
        ...
        while not stopJSONRPCNotifications.isSet():
            ...
            try:
                if debug:
                    print(
                        "XBMC2: Connecting to XBMC, to be able to recive JSON-RPC notifications.")
                s.connect((self.pluginConfig['XBMC']['ip'],
                self.pluginConfig['JSONRPC']['port']))
            except socket.error:
                if debug:
                    ...
                    traceback.print_exc()
                    print(
                        "XBMC2: Not able to connect to XBMC, will use SSDP to detect when XBMC is available.")
                WaitForXBMC(Socket)
            else:
                print("XBMC2: Connected to XBMC (",
                    self.pluginConfig['XBMC']['ip'], ":",
                    self.pluginConfig['JSONRPC']['port'],
                    "), ready to recive JSON-RPC notifications.")
                ...
                while not stopJSONRPCNotifications.isSet():
                    try:
                        if debug:
                            print(
                                "XBMC2: JSON-RPC notifications: Wait for event.")
                        message += s.recv(4096)
                        # print len(message)
                        if not message:
                            break
                        ...
                        if debug:
                            print(
                                "XBMC2: JSON-RPC notifications: Wait for event: Timeout.")
                        s.send(json.dumps(
                        ...
                        # else:Raw event: {'jsonrpc': '2.0', 'id': 1, 'result': 'pong'}
                        for message in messages:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    eg.PrintError(
                                        'XBMC2: Error: JSON-RPC event, "method" missing ' + repr(
                                            message))
                                    self.PrintError(
                                    ...
                                    try:
                                        if 'notifications' in message[
                                            ...
                                            if debug:
                                                print(
                                                    'XBMC2: JSON-RPC responce: "notifications":',
                                                    message['result'][
                                                        'notifications'])
                                            continue
                                    except KeyError:
                                        if debug:
                                            eg.PrintError(
                                                'XBMC2: Error: JSON-RPC responce, "result" missing ' + repr(
                                                    message))
                                    else:
                                        if message['result'] == 'pong':
                                            if debug:
                                                print(
                                                    'XBMC2: JSON-RPC responce: "pong".')
                                            continue
                                        else:
                                            eg.PrintError(
                                                'XBMC2: Error: JSON-RPC responce, "pong" missing ' + repr(
                                                    message))
                                            self.PrintError(
                                                'JSON unrecogniced responce type: \n' + "Raw responce: %s" % repr(
                                                    message))
                            else:
                                try:
                                    ...
                                    if not payload == None:
                                        try:
                                            ...
                                            self.PrintError(
                                                'XBMC2: JSON unrecogniced event type: \n' + "Raw event: %s" % repr(
                                                    message))
                ...
                s.close()
                print(
                    "XBMC2: Disconnected from XBMC, not receiving JSON-RPC notifications.")
    ...
    def BroadcastEvents(self, stopBroadcastEvents):
        ...
        # with spincontrols you can enter 3digit number to quickly set
            ...
            '69':    'ACTION_OSD_SHOW_LEFT',
        # Move left in OSD. Can b used in videoFullScreen.xml window id=2005
            '70':    'ACTION_OSD_SHOW_RIGHT',
        # Move right in OSD. Can b used in videoFullScreen.xml window id=2005
            '71':    'ACTION_OSD_SHOW_UP',
        # Move up in OSD. Can b used in videoFullScreen.xml window id=2005
            '72':    'ACTION_OSD_SHOW_DOWN',
        # Move down in OSD. Can b used in videoFullScreen.xml window id=2005
            '73':    'ACTION_OSD_SHOW_SELECT',
        # toggle/select option in OSD. Can b used in videoFullScreen.xml window id=2005
            '74':    'ACTION_OSD_SHOW_VALUE_PLUS',
        # increase value of current option in OSD. Can b used in videoFullScreen.xml window id=2005
            '75':    'ACTION_OSD_SHOW_VALUE_MIN',
        # decrease value of current option in OSD. Can b used in videoFullScreen.xml window id=2005
            '76':    'ACTION_SMALL_STEP_BACK',
        # jumps a few seconds back during playback of movie. Can b used in videoFullScreen.xml window id=2005

            '77':    'ACTION_PLAYER_FORWARD',
        # FF in current file played. global action, can be used anywhere
            '78':    'ACTION_PLAYER_REWIND',
        # RW in current file played. global action, can be used anywhere
            '79':    'ACTION_PLAYER_PLAY',
        # Play current song. Unpauses song and sets playspeed to 1x. global action, can be used anywhere

            '80':    'ACTION_DELETE_ITEM',
        ...
        # move current selected item. Can be used in myfiles.xml window id=3
            '83':    'ACTION_SHOW_MPLAYER_OSD',
        # toggles mplayers OSD. Can be used in videofullscreen.xml window id=2005
            '84':    'ACTION_OSD_HIDESUBMENU',
        # removes an OSD sub menu. Can be used in videoOSD.xml window id=2901
        ...
        # jump direct to a particular letter using SMS-style input
            ...
            '202':   'ACTION_TOGGLE_DIGITAL_ANALOG',
        # switch digital <-> analog
            '203':   'ACTION_RELOAD_KEYMAPS',
        # reloads CButtonTranslator's keymaps
            '204':   'ACTION_GUIPROFILE_BEGIN',
        # start the GUIControlProfiler running

            '215':   'ACTION_TELETEXT_RED',
        # Teletext Color buttons to control TopText
            ...
            '228':   'ACTION_VSHIFT_DOWN',
        # shift down video image in DVDPlayer

            '229':   'ACTION_PLAYER_PLAYPAUSE',
        # Play/pause. If playing it pauses, if paused it plays.
            ...
            '230':   'ACTION_SUBTITLE_VSHIFT_UP',
        # shift up subtitles in DVDPlayer
            '231':   'ACTION_SUBTITLE_VSHIFT_DOWN',
        # shift down subtitles in DVDPlayer
            '232':   'ACTION_SUBTITLE_ALIGN',
        # toggle vertical alignment of subtitles
            ...
            '10005': 'WINDOW_MUSIC',
        # virtual window to return the music start window.
            '10006': 'WINDOW_VIDEOS',
            ...
            '10020': 'WINDOW_SCRIPTS',
        # virtual window for backward compatibility
            ...
            '12905': 'WINDOW_VIDEO_TIME_SEEK',
        # virtual window for time seeking during fullscreen video
        ...
        while not stopBroadcastEvents.isSet():
            ...
            if self.pluginConfig['XBMC']['ip'] != addr[0]:
                if self.pluginConfig['XBMC']['ip'] == '127.0.0.1':
                    if not addr[0] in socket.gethostbyname_ex('')[2]:
                        continue
                else:
                    continue
            """
